...
//       <span className='font-light select-none'> {label}
//         </span>
//           </label>
//   )
// }
...
//   ]
//   return (
//     <div className='flex flex-col  items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>

//       <div className='flex flex-col items-start text-left mb-8'>
//         <h1 className='font-playfair text-4xl md:text-[40px]'> Hotel Rooms</h1>
//         <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-prose'> Take Advantage of our limited-Time Offers and special packages to enhance your stay and create unforgattable memories.</p>
//       </div>
// {/* /Room Dummy Datas */}
...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      
      {/* Main Content */}
      <div className='flex-1 md:mr-8'>
        <div className='flex flex-col items-start text-left mb-8'>
          <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms</h1>
          <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-prose'>
