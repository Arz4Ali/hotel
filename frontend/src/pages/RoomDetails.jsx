...
//         <h1 className='text-3xl md:text-4xl font-playfair'> {room.hotel.name} <span className='font-inter text-sm'> ({room.roomType})
//         </span>
//         </h1>
...
//       {/* Room Address */}
//       <div className='flex items-center gap-1 text-gray-500 mt-2'> <img src={assets.locationIcon} alt="location-icon" />
...
//             </div>
//             <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white roundede-md max-md:w-full  max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'> Check Availability  </button>
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
          {room?.images.length > 1 && room.images.map((image, index) => (
            <img
              ...
              src={image}
              alt='Room Image'
              className={`w - full h-44 rounded-xl shadow-md object-cover cursor-pointer transition-all ${mainImage === image ? 'outline outline-3 outline-orange-500' : 'hover:opacity-80'}`}
            />
          ))}
        </div>
      </div>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        <div className='flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          <div className='flex flex-col'>
            ...
            <input
              ...
              className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none focus:border-orange-500'
              required
            />
          </div>

          {/* Separator */}
          <div className='w-px h-16 bg-gray-300 opacity-70 max-md:hidden'></div>
          ...
          <div className='flex flex-col'>
            ...
            <input
              ...
              id="guests"
              placeholder='0'
              className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none focus:border-orange-500'
              required
            />
          </div>
        </div>
        ...
        <button
          type='submit'
          className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 px-6 md:px-8 py-3 md:py-4 text-base cursor-pointer'
        >
          Check Availability
        </button>
      </form>
